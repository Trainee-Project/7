...
-- -----------------------------------------------------
-- Table `mydb`.`People_has_Skillset`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`People_has_Skillset` (
  ...
  CONSTRAINT `fk_People_has_Skillset_People1`
    ...
    REFERENCES `mydb`.`People` (`Person ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `mydb`.`People_on_Project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`People_on_Project` (
  `People_Person ID` INT NOT NULL,
